...
statusbar = ttk.Label(root, text="MP3 Music Player", anchor=W, font='Arial 8 italic')
statusbar.pack(side=BOTTOM, fill=X)
statusbar1 = ttk.Label(root, text="MP3 Music Player", anchor=W, font='Arial 8 italic')
...
ltframe = Frame(root,bg="#000000")
ltframe.pack(side=LEFT, padx=30, pady=30)
songplaylistcontainer = Listbox(ltframe,fg='#000000')
songplaylistcontainer["bg"]="#FFFFFF"
...
root.style.configure('TButton', background='#ffff00')
rtframe = Frame(root,bg="#FFFFFF")
rtframe.pack(pady=50,padx=30)
topframe = Frame(rtframe,bg="#FFFF00")
topframe.pack()
root.style = ttk.Style()
#root.style.theme_use("clam")
root.style.configure('TLabel', background='#FFFF00')
...
def play_music():
    ...
    if paused:
        ...
        try:
            ...
            tkinter.messagebox.showerror('File not found', 'MP3 Music Player could not find the file. Please select again.')
def stop_music():
    mixer.music.stop()
...
def mute_music():
    ...
    if muted:
        ...
        scale.set(0)
        muted = TRUE
middleframe = Frame(rtframe,bg="#000000")
...
bottomframe = Frame(rtframe,bg="#000000")
